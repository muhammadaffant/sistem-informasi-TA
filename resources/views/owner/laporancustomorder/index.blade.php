    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-inline">
                ...
                <a href="{{ route('owner.laporancustomorder.export') }}" id="exportBtn" class="btn btn-success mb-2 ml-2">
                    Export Excel
                </a>
            </form>
        </div>
...
<script>
    function updateExportLink() {
        ...
        let baseUrl = '{{ route("owner.laporancustomorder.export") }}';
    ...
    $(document).ready(function() {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('owner.laporancustomorder.data') }}',
                data: function (d) {
