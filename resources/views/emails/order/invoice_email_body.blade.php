...
<head>
    ...
    <style>
        /* Style untuk fallback jika ada email client yang mendukung */
        body {
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin-top: 30px; border-top: 1px solid #eeeeee;">
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding-bottom: 15px;">
                                            <h3 style="margin: 0; font-size: 18px; font-weight: 600;">Ringkasan Pesanan</h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px; padding: 8px 0; color: #555;">Nomor Invoice</td>
                                        <td style="padding: 8px 0;">: <strong>#{{ $order->invoice_no }}</strong></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px; padding: 8px 0; color: #555;">Tanggal Pesanan</td>
                                        <td style="padding: 8px 0;">: {{ $order->created_at->format('d F Y') }}</td>
                                    </tr>
                                     <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0; font-weight: bold; color: #0056b3;">: Rp {{ number_format($order->amount, 0, ',', '.') }}</td>
                                    </tr>
                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #0056b3; border-radius: 5px; text-align: center;">
                                                                <a href="{{ route('user.order') }}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #0056b3; border: solid 1px #0056b3; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #0056b3;">Lihat Riwayat Pesanan</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
